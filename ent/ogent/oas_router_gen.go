					...
					case '/': // Prefix: "/"
						...
						if len(elem) == 0 {
							...
							case "DELETE":
								...
								r.pathPattern = "/rest/bar-groups/{id}"
								r.args = args
								r.count = 1
								return r, true
							case "GET":
							...
							case 'r': // Prefix: "records"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.pathPattern = "/rest/bar-groups/{id}/records"
										r.args = args
										r.count = 1
										return r, true
									default:
							...
							case 't': // Prefix: "time-range"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.pathPattern = "/rest/bar-groups/{id}/time-range"
										r.args = args
										r.count = 1
										return r, true
									default:
				...
				case 'r': // Prefix: "records"
					...
					if len(elem) == 0 {
						...
						case "GET":
							...
							r.pathPattern = "/rest/bar-records"
							r.args = args
							r.count = 0
							return r, true
						case "POST":
					...
					case '/': // Prefix: "/"
						...
						if len(elem) == 0 {
							...
							case "DELETE":
								...
								r.pathPattern = "/rest/bar-records/{id}"
								r.args = args
								r.count = 1
								return r, true
							case "GET":
						...
						case '/': // Prefix: "/group"
							...
							if len(elem) == 0 {
								...
								case "GET":
									...
									r.pathPattern = "/rest/bar-records/{id}/group"
									r.args = args
									r.count = 1
									return r, true
								default:
				...
				case 't': // Prefix: "time-ranges"
					...
					if len(elem) == 0 {
						...
						case "GET":
							...
							r.pathPattern = "/rest/bar-time-ranges"
							r.args = args
							r.count = 0
							return r, true
						case "POST":
					...
					case '/': // Prefix: "/"
						...
						if len(elem) == 0 {
							...
							case "DELETE":
								...
								r.pathPattern = "/rest/bar-time-ranges/{id}"
								r.args = args
								r.count = 1
								return r, true
							case "GET":
							...
							case 'g': // Prefix: "groups"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.pathPattern = "/rest/bar-time-ranges/{id}/groups"
										r.args = args
										r.count = 1
										return r, true
									default:
							...
							case 'i': // Prefix: "interval"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.pathPattern = "/rest/bar-time-ranges/{id}/interval"
										r.args = args
										r.count = 1
										return r, true
									default:
				...
				case 'a': // Prefix: "ata-sources"
					...
					if len(elem) == 0 {
						...
						case "GET":
							...
							r.pathPattern = "/rest/data-sources"
							r.args = args
							r.count = 0
							return r, true
						case "POST":
					...
					case '/': // Prefix: "/"
						...
						if len(elem) == 0 {
							...
							case "DELETE":
								...
								r.pathPattern = "/rest/data-sources/{id}"
								r.args = args
								r.count = 1
								return r, true
							case "GET":
						...
						case '/': // Prefix: "/intervals"
							...
							if len(elem) == 0 {
								...
								case "GET":
									...
									r.pathPattern = "/rest/data-sources/{id}/intervals"
									r.args = args
									r.count = 1
									return r, true
								default:
					...
					case '/': // Prefix: "/"
						...
						if len(elem) == 0 {
							...
							case "DELETE":
								...
								r.pathPattern = "/rest/dividends/{id}"
								r.args = args
								r.count = 1
								return r, true
							case "GET":
						...
						case '/': // Prefix: "/stock"
							...
							if len(elem) == 0 {
								...
								case "GET":
									...
									r.pathPattern = "/rest/dividends/{id}/stock"
									r.args = args
									r.count = 1
									return r, true
								default:
					...
					case '/': // Prefix: "/"
						...
						case 'a': // Prefix: "add/"
							...
							if len(elem) == 0 {
								...
								case "POST":
									...
									r.pathPattern = "/rest/entities/add/{ticker}"
									r.args = args
									r.count = 1
									return r, true
								default:
						...
						if len(elem) == 0 {
							...
							case "DELETE":
								...
								r.pathPattern = "/rest/entities/{id}"
								r.args = args
								r.count = 1
								return r, true
							case "GET":
							...
							case 'd': // Prefix: "dividends"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.pathPattern = "/rest/entities/{id}/dividends"
										r.args = args
										r.count = 1
										return r, true
									default:
							...
							case 'e': // Prefix: "exchanges"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.pathPattern = "/rest/entities/{id}/exchanges"
										r.args = args
										r.count = 1
										return r, true
									default:
							...
							case 'f': // Prefix: "financials"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.pathPattern = "/rest/entities/{id}/financials"
										r.args = args
										r.count = 1
										return r, true
									default:
							...
							case 'i': // Prefix: "intervals"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.pathPattern = "/rest/entities/{id}/intervals"
										r.args = args
										r.count = 1
										return r, true
									default:
							...
							case 's': // Prefix: "splits"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.pathPattern = "/rest/entities/{id}/splits"
										r.args = args
										r.count = 1
										return r, true
									default:
					...
					case '/': // Prefix: "/"
						...
						if len(elem) == 0 {
							...
							case "DELETE":
								...
								r.pathPattern = "/rest/exchanges/{id}"
								r.args = args
								r.count = 1
								return r, true
							case "GET":
						...
						case '/': // Prefix: "/stocks"
							...
							if len(elem) == 0 {
								...
								case "GET":
									...
									r.pathPattern = "/rest/exchanges/{id}/stocks"
									r.args = args
									r.count = 1
									return r, true
								default:
				...
				case '/': // Prefix: "/"
					...
					if len(elem) == 0 {
						...
						case "DELETE":
							...
							r.pathPattern = "/rest/financials/{id}"
							r.args = args
							r.count = 1
							return r, true
						case "GET":
					...
					case '/': // Prefix: "/stock"
						...
						if len(elem) == 0 {
							...
							case "GET":
								...
								r.pathPattern = "/rest/financials/{id}/stock"
								r.args = args
								r.count = 1
								return r, true
							default:
				...
				case '/': // Prefix: "/"
					...
					if len(elem) == 0 {
						...
						case "DELETE":
							...
							r.pathPattern = "/rest/intervals/{id}"
							r.args = args
							r.count = 1
							return r, true
						case "GET":
						...
						case 'b': // Prefix: "bars"
							...
							if len(elem) == 0 {
								...
								case "GET":
									...
									r.pathPattern = "/rest/intervals/{id}/bars"
									r.args = args
									r.count = 1
									return r, true
								default:
						...
						case 'd': // Prefix: "data-source"
							...
							if len(elem) == 0 {
								...
								case "GET":
									...
									r.pathPattern = "/rest/intervals/{id}/data-source"
									r.args = args
									r.count = 1
									return r, true
								default:
						...
						case 's': // Prefix: "stock"
							...
							if len(elem) == 0 {
								...
								case "GET":
									...
									r.pathPattern = "/rest/intervals/{id}/stock"
									r.args = args
									r.count = 1
									return r, true
								default:
						...
						case 't': // Prefix: "trades"
							...
							if len(elem) == 0 {
								...
								case "GET":
									...
									r.pathPattern = "/rest/intervals/{id}/trades"
									r.args = args
									r.count = 1
									return r, true
								default:
				...
				case 'h': // Prefix: "hours"
					...
					if len(elem) == 0 {
						...
						case "GET":
							...
							r.pathPattern = "/rest/market-hours"
							r.args = args
							r.count = 0
							return r, true
						case "POST":
					...
					case '/': // Prefix: "/"
						...
						if len(elem) == 0 {
							...
							case "DELETE":
								...
								r.pathPattern = "/rest/market-hours/{id}"
								r.args = args
								r.count = 1
								return r, true
							case "GET":
						...
						case '/': // Prefix: "/market-info"
							...
							if len(elem) == 0 {
								...
								case "GET":
									...
									r.pathPattern = "/rest/market-hours/{id}/market-info"
									r.args = args
									r.count = 1
									return r, true
								default:
				...
				case 'i': // Prefix: "infos"
					...
					if len(elem) == 0 {
						...
						case "GET":
							...
							r.pathPattern = "/rest/market-infos"
							r.args = args
							r.count = 0
							return r, true
						case "POST":
					...
					case '/': // Prefix: "/"
						...
						if len(elem) == 0 {
							...
							case "DELETE":
								...
								r.pathPattern = "/rest/market-infos/{id}"
								r.args = args
								r.count = 1
								return r, true
							case "GET":
						...
						case '/': // Prefix: "/hours"
							...
							if len(elem) == 0 {
								...
								case "GET":
									...
									r.pathPattern = "/rest/market-infos/{id}/hours"
									r.args = args
									r.count = 1
									return r, true
								default:
				...
				case 'e': // Prefix: "earch/"
					...
					if len(elem) == 0 {
						...
						case "GET":
							...
							r.pathPattern = "/rest/search/{ticker}"
							r.args = args
							r.count = 1
							return r, true
						default:
						...
						case '/': // Prefix: "/stock"
							...
							if len(elem) == 0 {
								...
								case "GET":
									...
									r.pathPattern = "/rest/splits/{id}/stock"
									r.args = args
									r.count = 1
									return r, true
								default:
					...
					case 'n': // Prefix: "nditions"
						...
						if len(elem) == 0 {
							...
							case "GET":
								...
								r.pathPattern = "/rest/trade-conditions"
								r.args = args
								r.count = 0
								return r, true
							case "POST":
						...
						case '/': // Prefix: "/"
							...
							if len(elem) == 0 {
								...
								case "DELETE":
									...
									r.pathPattern = "/rest/trade-conditions/{id}"
									r.args = args
									r.count = 1
									return r, true
								case "GET":
							...
							case '/': // Prefix: "/record"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.pathPattern = "/rest/trade-conditions/{id}/record"
										r.args = args
										r.count = 1
										return r, true
									default:
					...
					case 'r': // Prefix: "rrections"
						...
						if len(elem) == 0 {
							...
							case "GET":
								...
								r.pathPattern = "/rest/trade-corrections"
								r.args = args
								r.count = 0
								return r, true
							case "POST":
						...
						case '/': // Prefix: "/"
							...
							if len(elem) == 0 {
								...
								case "DELETE":
									...
									r.pathPattern = "/rest/trade-corrections/{id}"
									r.args = args
									r.count = 1
									return r, true
								case "GET":
							...
							case '/': // Prefix: "/record"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.pathPattern = "/rest/trade-corrections/{id}/record"
										r.args = args
										r.count = 1
										return r, true
									default:
				...
				case 'r': // Prefix: "records"
					...
					if len(elem) == 0 {
						...
						case "GET":
							...
							r.pathPattern = "/rest/trade-records"
							r.args = args
							r.count = 0
							return r, true
						case "POST":
					...
					case '/': // Prefix: "/"
						...
						if len(elem) == 0 {
							...
							case "DELETE":
								...
								r.pathPattern = "/rest/trade-records/{id}"
								r.args = args
								r.count = 1
								return r, true
							case "GET":
								...
								case 'n': // Prefix: "nditions"
									...
									if len(elem) == 0 {
										...
										case "GET":
											...
											r.pathPattern = "/rest/trade-records/{id}/conditions"
											r.args = args
											r.count = 1
											return r, true
										default:
								...
								case 'r': // Prefix: "rrection"
									...
									if len(elem) == 0 {
										...
										case "GET":
											...
											r.pathPattern = "/rest/trade-records/{id}/correction"
											r.args = args
											r.count = 1
											return r, true
										default:
							...
							case 'e': // Prefix: "exchange"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.pathPattern = "/rest/trade-records/{id}/exchange"
										r.args = args
										r.count = 1
										return r, true
									default:
							...
							case 't': // Prefix: "time-range"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.pathPattern = "/rest/trade-records/{id}/time-range"
										r.args = args
										r.count = 1
										return r, true
									default:
				...
				case 't': // Prefix: "time-ranges"
					...
					if len(elem) == 0 {
						...
						case "GET":
							...
							r.pathPattern = "/rest/trade-time-ranges"
							r.args = args
							r.count = 0
							return r, true
						case "POST":
					...
					case '/': // Prefix: "/"
						...
						if len(elem) == 0 {
							...
							case "DELETE":
								...
								r.pathPattern = "/rest/trade-time-ranges/{id}"
								r.args = args
								r.count = 1
								return r, true
							case "GET":
							...
							case 'i': // Prefix: "interval"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.pathPattern = "/rest/trade-time-ranges/{id}/interval"
										r.args = args
										r.count = 1
										return r, true
									default:
							...
							case 'r': // Prefix: "records"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.pathPattern = "/rest/trade-time-ranges/{id}/records"
										r.args = args
										r.count = 1
										return r, true
									default:
